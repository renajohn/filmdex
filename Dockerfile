...
# Install build dependencies for native modules (sqlite3), curl for LLM cover scan, ffmpeg for image processing
RUN apk add --no-cache python3 make g++ sqlite-dev curl ffmpeg
