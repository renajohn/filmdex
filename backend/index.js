...
app.get('/api/movies/collections/max-order', movieController.getCollectionMaxOrder);
app.get('/api/movies/collections/movies', movieController.getMoviesByCollection);
app.put('/api/movies/collections/order', movieController.updateCollectionOrder);
